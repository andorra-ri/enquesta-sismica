...
const json = {
  ...
  noise: "weak",
  reaction: "smallFright",
  standingDifficulty: "notSpecified",
  animalsFrightened: "yes",
  effectsLamps: "bigOscilation",
  effectsLiquids: "notSpecified",
  effectsPaintings: "moved",
  effectsDoorsWindows: "notSpecified",
  effectsFurniture: "fall",
  effectsPlants: "dontKnow",
  effectsShelves: "mostFall",
  commentseffectsShelves: "Cooments on shelves",
  buildingType: "typeB",
  buildingDamage: "yes",
...
console.log(createXMLReport(json));
