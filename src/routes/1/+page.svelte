  ...
  <Card padded>
    ...
    {#if formValues.whatDidYouDo === "other"}
      <FormField>
        ...
        <Textfield
          style="width:70%"
          bind:value={formValues.commentsWhatDidYouDo}
          type="email"
        />
      </FormField>
    {/if}
  ...
  {#if formValues.position === "insideBuilding"}
    <Card padded>
      ...
      <Select
        style="max-width: 400px"
        label="A les plantes:"
        bind:value={formValues.effectsPlants}
      >
      ...
      <FormField style="width: 100%">
        ...
        <Textfield
          style="width: 70%"
          bind:value={formValues.commentseffectsShelves}
          type="email"
        />
      </FormField>
    </Card>
      ...
      {#if formValues.buildingDamage === "yes"}
        ...
        <div>
          <FormField style="width: 100%">
            ...
            <Textfield
              bind:value={formValues.commentsDamage}
              style="width: 100%"
              type="email"
            />
          </FormField>
  ...
  <Card padded>
    ...
    {#if formValues.otherSeisms === "yes"}
      <FormField>
        ...
        <Textfield
          style="width: 70%"
          bind:value={formValues.otherSeismsText}
          type="email"
        />
      </FormField>
    {/if}
