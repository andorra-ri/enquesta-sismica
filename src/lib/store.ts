...
export const surveyValues = writable<FormValues>({
	...
	streetNumber: '',
	addressNotes: '',
	numberPeopleInside: 'notSpecified',
	...
	effectsPlants: 'notSpecified',
	effectsShelves: 'notSpecified',
	buildingType: 'notSpecified',
	buildingDamage: 'notSpecified',
	otherSeisms: 'notSpecified',
	commentsPosition: '',
	commentsBuilding: '',
...
export const schema = yup.object().shape({
	...
	numberPeopleInside: yup.string().oneOf(Object.keys(numberPeopleInsideOptions)),
	numberPeopleOutside: yup.string().oneOf(Object.keys(numberPeopleOutsideOptions)),
	numberPeopleGoingOut: yup.string().oneOf(Object.keys(numberPeopleGoingOutOptions)),
